...
const galleryPhotos=[
  {src:'assets/hero/facility-exterior-cursive-v3.webp',category:'Facility',title:'Our Kaduna facility',description:'A real view of the Biotin Feeds operation at BR 4, Nnamdi Azikiwe Expressway, Ungwan Muazu, Kaduna.',alt:'Exterior of the Biotin Feeds facility in Kaduna'},
  ...
  {src:'assets/hero/biosecurity-vehicle-cursive-v3.webp',category:'',title:'Keeping Biosecurity Measures Before Entry of Vehicles',description:'',alt:'Workers keeping biosecurity measures before entry of a Biotin Feeds vehicle'},
  ...
  {src:'assets/gallery/layers-production-proof-v1.webp',category:'Layers',title:'The Proof is in the Production. Guaranteed Performance.',description:"Healthy birds don't just happen. They're fed for it. Our premium layers mash is formulated for strong immunity, high laying percentage, and those rich, large-size golden-brown eggs customers love.",alt:'Healthy laying hens producing golden-brown eggs at a poultry farm'}
];
